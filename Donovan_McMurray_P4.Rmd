...
```{r echo=FALSE, warning=FALSE, message=FALSE}
ggplot(aes(ALL_RATE), data=data) + xlab("Graduation Rate") + 
  geom_histogram(fill="lightblue", color="black", binwidth=1)
summary(data$ALL_RATE)
```

```{r echo=FALSE, warning=FALSE, message=FALSE}
ggplot(aes(ALL_COHORT), data=data) + xlab("Number of Students Per School") + 
...
```{r echo=FALSE, warning=FALSE, message=FALSE}
ggplot(aes(Total.General.Revenue.Per.Student), data=data) + 
  xlab("Revenue Per Student") + 
  geom_histogram(fill="lightgreen", color="black", binwidth=10000)
ggplot(aes(Total.General.Revenue.Per.Student), data=data) + 
  xlab("Revenue Per Student") + 
  geom_histogram(fill="lightgreen", color="black", binwidth=.05) + 
...
data.state_means <- data %>% 
  ...
  summarise(ALL_RATE = mean(ALL_RATE, na.rm=TRUE),
            ...
            Total.General.Revenue.Per.Student = 
              mean(Total.General.Revenue.Per.Student, na.rm=TRUE),
            n = n(),
...
ggplot() + 
  geom_polygon(data=state_data, 
               aes(x=long, y=lat, group = group, fill=state_data$ALL_RATE),
               colour="white") + 
  scale_fill_continuous(low = "thistle2", high = "darkred", 
                        guide="colorbar", name="Graduation Rate") + 
  xlim(-130, -65)

ggplot() + 
  geom_polygon(data=state_data, 
               aes(x=long, y=lat, group = group, fill=state_data$ALL_COHORT),
               colour="white") + 
  scale_fill_continuous(low = "thistle2", high = "orange", 
                        guide="colorbar", name="Students per School") + 
  xlim(-130, -65)

ggplot() + 
  geom_polygon(data=state_data, 
               aes(x=long, y=lat, group = group, fill=state_data$Pupil.Teacher.Ratio),
               colour="white") + 
  scale_fill_continuous(low = "thistle2", high = "darkblue", 
                        guide="colorbar", name="Pupil/Teacher Ratio") + 
  xlim(-130, -65)

ggplot() + 
  geom_polygon(data=state_data, 
               aes(x=long, y=lat, group = group, 
                   fill=state_data$Total.General.Revenue.Per.Student),
               colour="white") + 
...
county_data <- left_join(all_counties, data.county_means, 
                         by=c("region", "subregion"))

ggplot() + 
  geom_polygon(data=county_data, 
               aes(x=long, y=lat, group = group, fill=county_data$ALL_RATE)) +
  scale_fill_continuous(low = "thistle2", high = "darkred", 
                        guide="colorbar", name="Graduation Rate")

ggplot() + 
  geom_polygon(data=county_data, 
               aes(x=long, y=lat, group = group, fill=county_data$ALL_COHORT)) +
  scale_fill_continuous(low = "thistle2", high = "orange", 
                        guide="colorbar", trans="log10", 
...
ggplot() + 
  geom_polygon(data=county_data, 
               aes(x=long, y=lat, group = group, 
                   fill=county_data$Pupil.Teacher.Ratio)) + 
  scale_fill_continuous(low = "thistle2", high = "darkblue", 
                        guide="colorbar", name="Pupil/Teacher Ratio")
...
ggplot() + 
  geom_polygon(data=county_data, 
               aes(x=long, y=lat, group = group, 
                   fill=county_data$Total.General.Revenue.Per.Student)) + 
  scale_fill_continuous(low = "thistle2", high = "darkgreen", 
                        guide="colorbar", trans="log10", 
                        name="Revenue per Student")
```
...
```{r echo=FALSE, warning=FALSE, message=FALSE}
data.state_means$Postal.Code <- 
  factor(data.state_means$Postal.Code, 
         as.character(data.state_means$Postal.Code))

ggplot(aes(x=Postal.Code), data=filter(data.state_means, !is.na(Postal.Code))) + 
  theme(axis.text.x = element_text(angle = 270, hjust = 1)) +
  geom_line(aes(y=ALL_RATE, group=2), color="black") +
  geom_point(aes(y=MAM_RATE, color="NativeAmerican")) + 
  geom_line(aes(y=MAM_RATE, group=2, color="NativeAmerican"), alpha=0.5) + 
  geom_point(aes(y=MAS_RATE, color="Asian")) + 
  geom_line(aes(y=MAS_RATE, group=2, color="Asian"), alpha=0.5) + 
  geom_point(aes(y=MBL_RATE, color="Black")) + 
  geom_line(aes(y=MBL_RATE, group=2, color="Black"), alpha=0.5) + 
  geom_point(aes(y=MHI_RATE, color="Hispanic")) + 
  geom_line(aes(y=MHI_RATE, group=2, color="Hispanic"), alpha=0.5) + 
  geom_point(aes(y=MTR_RATE, color="TwoPlusRaces")) + 
  geom_line(aes(y=MTR_RATE, group=2, color="TwoPlusRaces"), alpha=0.5) + 
  geom_point(aes(y=MWH_RATE, color="White")) + 
  geom_line(aes(y=MWH_RATE, group=2, color="White"), alpha=0.5) + 
  geom_point(aes(y=CWD_RATE, color="Disabled")) + 
  geom_line(aes(y=CWD_RATE, group=2, color="Disabled"), alpha=0.5) + 
  geom_point(aes(y=ECD_RATE, color="EconomicallyDisadv")) + 
  geom_line(aes(y=ECD_RATE, group=2, color="EconomicallyDisadv"), alpha=0.5) + 
  geom_point(aes(y=LEP_RATE, color="LimitedEnglish")) + 
  geom_line(aes(y=LEP_RATE, group=2, color="LimitedEnglish"), alpha=0.5) +
  scale_colour_manual(name="Cohorts", 
                      values=c(NativeAmerican="red", 
                               Asian="orange", 
                               Black="yellow", 
                               Hispanic="green", 
                               TwoPlusRaces="lightblue", 
                               White="blue", 
                               Disabled="darkblue", 
                               EconomicallyDisadv="purple", 
                               LimitedEnglish="magenta"))
```
...
```{r echo=FALSE, warning=FALSE, message=FALSE}
sub_cohorts <- select(data.state_means, c(-ALL_RATE, -MAM_RATE, -MAS_RATE, 
                                          -MBL_RATE, -MHI_RATE, -MTR_RATE, 
                                          -MWH_RATE, -CWD_RATE, -ECD_RATE, 
                                          -LEP_RATE, -CWD_COHORT, 
                                          -ECD_COHORT, -LEP_COHORT)) %>% 
  gather(DEMO, COHORT, MAM_COHORT, MAS_COHORT, 
         MBL_COHORT, MHI_COHORT, MTR_COHORT, MWH_COHORT) %>% 
...
sub_cohorts$Postal.Code <- 
  factor(sub_cohorts$Postal.Code, as.character(sub_cohorts$Postal.Code))

sub_cohorts$COHORT <- ifelse(is.nan(sub_cohorts$COHORT), 0, sub_cohorts$COHORT)

ggplot(aes(x=Postal.Code, y=COHORT), data=sub_cohorts) + 
  theme(axis.text.x = element_text(angle = 270, hjust = 1)) +
...
```{r echo=FALSE, warning=FALSE, message=FALSE}
ggplot(aes(x=Pupil.Teacher.Ratio, y=ALL_RATE), data=data) + 
  geom_point(aes(size=Total.General.Revenue.Per.Student, color=region), 
             alpha=0.15) + 
...
revRanks <- data %>% group_by(Postal.Code) %>% 
  summarize(rev.per.student=
              mean(Total.General.Revenue.Per.Student, na.rm=TRUE)) %>% 
  arrange(desc(rev.per.student)) %>% 
  mutate(rev.per.student.rank=row_number())
revRanks <- revRanks %>% 
  mutate(rev.per.student.rank=dim(revRanks)[1]-rev.per.student.rank)
...
gradRanks <- gradRanks %>% 
  mutate(grad.rate.rank=dim(gradRanks)[1]-grad.rate.rank)
...
```{r echo=FALSE, warning=FALSE, message=FALSE}
p<-ggplot(sizeRanks) + 
  geom_segment(aes(x=0,xend=1,y=size.rank,yend=grad.rate.rank),size=.75) + 
...
p<-p + geom_text(label=sizeRanks$Postal.Code, 
                 y=sizeRanks$grad.rate.rank, x=1,hjust=-0.2,size=2)
p<-p + geom_text(label=sizeRanks$Postal.Code, 
                 y=sizeRanks$size.rank, x=0,hjust=1.2,size=2)
p<-p + geom_text(label="Revenue Per Student Ranks", x=0, 
                 y=(1.03*(max(sizeRanks$grad.rate.rank,
                              sizeRanks$size.rank))),hjust= 0.1,size=3.5)
p<-p + geom_text(label="Graduation Rate Ranks", x=1, 
                 y=(1.03*(max(sizeRanks$grad.rate.rank,
                              sizeRanks$size.rank))),hjust= 0.9,size=3.5)
p

p<-ggplot(ratioRanks) + 
  geom_segment(aes(x=0,xend=1,y=ratio.rank,yend=grad.rate.rank),size=.75) + 
  scale_x_continuous(breaks = c())
p<-p + theme(panel.background = element_blank())
p<-p + theme(panel.grid=element_blank())
p<-p + theme(axis.ticks=element_blank())
p<-p + theme(axis.text=element_blank())
p<-p + theme(panel.border=element_blank())     
p<-p + geom_text(label=ratioRanks$Postal.Code, 
                 y=ratioRanks$grad.rate.rank, x=1,hjust=-0.2,size=2)
p<-p + geom_text(label=ratioRanks$Postal.Code, 
                 y=ratioRanks$ratio.rank, x=0,hjust=1.2,size=2)
p<-p + geom_text(label="Revenue Per Student Ranks", x=0,
                 y=(1.03*(max(ratioRanks$grad.rate.rank,
                              ratioRanks$ratio.rank))),
                 hjust= 0.1,size=3.5)
p<-p + geom_text(label="Graduation Rate Ranks", x=1,
                 y=(1.03*(max(ratioRanks$grad.rate.rank,
                              ratioRanks$ratio.rank))),
...
p<-ggplot(revRanks) + 
  geom_segment(aes(x=0,xend=1,
                   y=rev.per.student.rank,yend=grad.rate.rank),size=.75) + 
  scale_x_continuous(breaks = c())
p<-p + theme(panel.background = element_blank())
p<-p + theme(panel.grid=element_blank())
p<-p + theme(axis.ticks=element_blank())
p<-p + theme(axis.text=element_blank())
p<-p + theme(panel.border=element_blank())     
p<-p + geom_text(label=revRanks$Postal.Code, 
                 y=revRanks$grad.rate.rank, x=1,hjust=-0.2,size=2)
p<-p + geom_text(label=revRanks$Postal.Code, 
                 y=revRanks$rev.per.student.rank, x=0,hjust=1.2,size=2)
p<-p + geom_text(label="Revenue Per Student Ranks", x=0,
                 y=(1.03*(max(revRanks$grad.rate.rank,
                              revRanks$rev.per.student.rank))),
                 hjust= 0.1,size=3.5)
p<-p + geom_text(label="Graduation Rate Ranks", x=1, 
                 y=(1.03*(max(revRanks$grad.rate.rank,
                              revRanks$rev.per.student.rank))),
...
top.and.bottom.ranks <- 
  filter(sizeRanks, 
         size.rank < number.of.ranks | 
           size.rank >= dim(sizeRanks)[1] - number.of.ranks)

p<-ggplot(top.and.bottom.ranks) + 
  geom_segment(aes(x=0,xend=1,y=size.rank,yend=grad.rate.rank),size=.75) + 
  scale_x_continuous(breaks = c())
p<-p + theme(panel.background = element_blank())
p<-p + theme(panel.grid=element_blank())
...
p<-p + theme(axis.text=element_blank())
p<-p + theme(panel.border=element_blank())  
p<-p + geom_text(label=top.and.bottom.ranks$Postal.Code, 
                 y=top.and.bottom.ranks$grad.rate.rank, x=1,hjust=-0.2,size=2)
p<-p + geom_text(label=top.and.bottom.ranks$Postal.Code, 
                 y=top.and.bottom.ranks$size.rank, x=0,hjust=1.2,size=2)
p<-p + geom_text(label="Revenue Per Student Ranks", x=0,
                 y=(1.03*(max(top.and.bottom.ranks$grad.rate.rank,
                              top.and.bottom.ranks$size.rank))),
                 hjust= 0.1,size=3.5)
p<-p + geom_text(label="Graduation Rate Ranks", x=1,
                 y=(1.03*(max(top.and.bottom.ranks$grad.rate.rank,
                              top.and.bottom.ranks$size.rank))),
...
top.and.bottom.ranks <- 
  filter(ratioRanks, ratio.rank < number.of.ranks | 
           ratio.rank >= dim(ratioRanks)[1] - number.of.ranks)
...
p<-p + geom_text(label=top.and.bottom.ranks$Postal.Code, 
                 y=top.and.bottom.ranks$grad.rate.rank, x=1,hjust=-0.2,size=2)
p<-p + geom_text(label=top.and.bottom.ranks$Postal.Code, 
                 y=top.and.bottom.ranks$ratio.rank, x=0,hjust=1.2,size=2)
p<-p + geom_text(label="Revenue Per Student Ranks", x=0,
                 y=(1.03*(max(top.and.bottom.ranks$grad.rate.rank,
                              top.and.bottom.ranks$ratio.rank))),
                 hjust= 0.1,size=3.5)
p<-p + geom_text(label="Graduation Rate Ranks", x=1,
                 y=(1.03*(max(top.and.bottom.ranks$grad.rate.rank,
                              top.and.bottom.ranks$ratio.rank))),
...
top.and.bottom.ranks <- 
  filter(revRanks, rev.per.student.rank < number.of.ranks | 
           rev.per.student.rank >= dim(revRanks)[1] - number.of.ranks)

p<-ggplot(top.and.bottom.ranks) +
  geom_segment(aes(x=0,xend=1,y=rev.per.student.rank,yend=grad.rate.rank),size=.75) +
  scale_x_continuous(breaks = c())
p<-p + theme(panel.background = element_blank())
p<-p + theme(panel.grid=element_blank())
p<-p + theme(axis.ticks=element_blank())
...
p<-p + theme(panel.border=element_blank())            
p<-p + geom_text(label=top.and.bottom.ranks$Postal.Code, 
                 y=top.and.bottom.ranks$grad.rate.rank, 
                 x=1,hjust=-0.2,size=2)
p<-p + geom_text(label=top.and.bottom.ranks$Postal.Code, 
                 y=top.and.bottom.ranks$rev.per.student.rank, 
                 x=0,hjust=1.2,size=2)
p<-p + geom_text(label="Revenue Per Student Ranks", x=0,
                 y=(1.03*(max(top.and.bottom.ranks$grad.rate.rank,
                              top.and.bottom.ranks$rev.per.student.rank))),
                 hjust= 0.1,size=3.5)
p<-p + geom_text(label="Graduation Rate Ranks", x=1,
                 y=(1.03*(max(top.and.bottom.ranks$grad.rate.rank,
                              top.and.bottom.ranks$rev.per.student.rank))),
...
map1 <- ggplot() + 
  geom_polygon(data=state_data, aes(x=long, y=lat, group = group,
                                    fill=state_data$ALL_RATE),
               color="lightgray") + 
  scale_fill_continuous(low = "#EEEEEE", high = "darkred", 
                        guide="colorbar", name="Graduation Rate        ") + 
  xlab("") + ylab("") + 
  scale_x_continuous(breaks=c(), limits=c(-130, -65)) +
  scale_y_continuous(breaks=c()) + 
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
        panel.background = element_blank(), 
        axis.line = element_line(colour = "white")) + 
  ggtitle("Graduation Rate by State")
...
map2 <- ggplot() + 
  geom_polygon(data=state_data, 
               aes(x=long, y=lat, group = group,
                   fill=state_data$Total.General.Revenue.Per.Student),
               colour="lightgray") + 
  scale_fill_continuous(low = "#DDDDDD", high = "darkgreen", 
                        guide="colorbar", trans="log10", 
                        name="Revenue per Student", 
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank(), 
        axis.line = element_line(colour = "white")) + 
  ggtitle("Revenue per Student by State")
